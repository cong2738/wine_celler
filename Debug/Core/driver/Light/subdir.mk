...
C_SRCS += \
../Core/driver/Light/light.c 

OBJS += \
./Core/driver/Light/light.o 

C_DEPS += \
./Core/driver/Light/light.d 


# Each subdirectory must supply rules for building sources it contributes
Core/driver/Light/%.o Core/driver/Light/%.su Core/driver/Light/%.cyclo: ../Core/driver/Light/%.c Core/driver/Light/subdir.mk
...
clean: clean-Core-2f-driver-2f-Light

clean-Core-2f-driver-2f-Light:
	-$(RM) ./Core/driver/Light/light.cyclo ./Core/driver/Light/light.d ./Core/driver/Light/light.o ./Core/driver/Light/light.su

.PHONY: clean-Core-2f-driver-2f-Light
